...
app = create(["A3AGLYMGYMEZ4WMNBPCSMTP2SYDWLMDLNTSJXYU7V5Q77NSCXW5G5EPG6M","SUXUKCFO2V2VFAFU6R3XUT3RVDKLK3BJRBAIAADYHQGZDJFFHMVOBF3CHA","password","2"])
print(app)
print(res)